...
function populateStates_1( countryElementId, stateElementId ){
...
function populateCountries_1(countryElementId, stateElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var countryElement = document.getElementById(countryElementId);
	countryElement.length=0;
	countryElement.options[0] = new Option('Select Country','-1');
	...
	if( stateElementId ){
		countryElement.onchange = function(){
			populateStates_1( countryElementId, stateElementId );
		};
	}
}

function populateStates_2( countryElementId, stateElementId ){
...
function populateCountries_2(countryElementId, stateElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var countryElement = document.getElementById(countryElementId);
	countryElement.length=0;
	countryElement.options[0] = new Option('Select Country','-1');
	...
	if( stateElementId ){
		countryElement.onchange = function(){
			populateStates_2( countryElementId, stateElementId );
		};
	}
}

function populateStates_3( countryElementId, stateElementId ){
...
function populateCountries_3(countryElementId, stateElementId){
	// given the id of the <select> tag as function argument, it inserts <option> tags
	var countryElement = document.getElementById(countryElementId);
	countryElement.length=0;
	countryElement.options[0] = new Option('Select Country','-1');
	...
	if( stateElementId ){
		countryElement.onchange = function(){
			populateStates_3( countryElementId, stateElementId );
		};
	}
}
