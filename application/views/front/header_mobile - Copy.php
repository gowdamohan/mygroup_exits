...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark" id="navabarpadding" style="background:#057284; padding-right: 0; padding-left:0 ">
  <div class="table-responsive">
    <ul class="navbar-nav" style="width:max-content;">
      ...
      <li class="nav-item text-center" style="line-height: 0.5; background:#057284;width: 2rem;line-height: 0.9;">
        <a class="nav-link" data-toggle="modal" data-target="#exampleModal" href="#">
          <i class="fa fa-th-large" style="color:#f0e8e8;" data-toggle="modal" data-target="#exampleModal"></i><br>
          <span style="font-size:9px; color:#f0e8e8">More</span>
        </a>
      </li>
       <li class="nav-item text-center" style="line-height: 0.5; position: fixed;background:#057284;width: 2rem;line-height: 0.9;">
        <a class="nav-link" data-toggle="modal" data-target="#exampleModal" href="#">
          <i class="fa fa-th-large" style="color:#f0e8e8;" data-toggle="modal" data-target="#exampleModal"></i><br>
          <span style="font-size:9px; color:#f0e8e8">More</span>
        </a>
      ...
      <?php foreach ($top_icon['myapps'] as $key => $val) {
          $active = '';
          if (isset($groupname) == $val->name) {
            $active ='active';
          }
        ?>
        <li class="nav-item text-center <?php echo $active ?>" style="line-height: 0.5; margin-right: 1.7rem;">
          <a class="nav-link" href="<?php echo site_url('group/'.$val->name) ?>">
            <img  style="width: 20px;" src="<?php echo base_url().$val->icon ?>"><br>
            <span style="font-size:9px"><?php echo $val->name ?></span>
            </a>
        </li>
      <?php } ?>
    </ul>
          ...
          <div class="wrapper" style="padding:0">
            <div class="btn" style="width: 100%; padding: 0;">
              <?php  $user = $this->ion_auth->user()->row(); ?>
                <?php if (!empty($user)) { ?>
                  <a  data-toggle="modal" onclick="open_setting_profile()"  data-target="#exampleModal1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <?php
                 ...
                 <!--  <i  class="fa fa-bars mobile-bar" aria-hidden="true"></i> -->
                  </a>
                <?php }else{ ?>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin-top: 24%;margin-bottom: 4px; ">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <a target="_blank" href="<?php echo $header_sliders->header_ads_url_1 ?>">
                <img class="d-block w-100" height="100px" src="<?php echo base_url().$header_sliders->header_ads1 ?>" alt="First slide">
              </a>
            </div>

            <div class="carousel-item">
              <a target="_blank" href="<?php echo $header_sliders->header_ads_url_2 ?>">
                <img class="d-block w-100" height="100px" src="<?php echo base_url().$header_sliders->header_ads2 ?>" alt="Second slide">
              </a>
            </div>

             <div class="carousel-item">
              <a target="_blank" href="<?php echo $header_sliders->header_ads_url_3 ?>">
                <img class="d-block w-100" height="100px" src="<?php echo base_url().$header_sliders->header_ads3 ?>" alt="Third slide">
              </a>
            </div>
  ...
  <div class="modal-dialog m-0" style="height:auto;">
    <div class="modal-content" style="height:auto; background: #4c4444; ">
      ...
      <div class="modal-body">
        <?php foreach ($total_apps as $title => $apps) {
          echo '<span style="font-size:1.2rem;color:#fff;font-weight: 700;">'.$title.'</span>';
          echo '<hr class="mt-1">';
          $chunk = array_chunk($apps, 4);
          ...
          echo ' <div class="row text-center">';
            ...
            echo '<div class="col-3" id="mobile_more">';
             echo ' <a class="nav-link" href="'.site_url($url).'">
              <img  style="width: 36px;" src="'.base_url().$val->icon.'"><br>
              <span style="font-size:9px;color:#fff">'.$val->name.'</span>
              </a>';
             echo '</div>';
            }
           echo  '</div>';
        ...
        <?php if (!empty($user)) { ?>
          ...
          <div class="row" id="linebotton">
            <div class="col-12" style="border-right:1px solid grey;">
              ...
              <?php $this->load->view('settings/'.$groupname); ?>
           ...
           <!--  <div class="col-12" style="border-right:1px solid grey;">
            ...
            <div class="footer-social-icon" style="margin-bottom: 14px; text-align:center; width: 100%;">
              <span>Follow us</span>
                <a target="_blank" href="#"><img class="social-icon-width" src="<?php echo base_url().'assets/front/img/social-icon/web sq.png' ?>"> </a>
                <a target="_blank" href="#"><img class="social-icon-width" src="<?php echo base_url().'assets/front/img/social-icon/youtube sq.png' ?>"> </a>
                <a target="_blank" href="#"><img class="social-icon-width" src="<?php echo base_url().'assets/front/img/social-icon/facebook sq.png' ?>"> </a>
                <a target="_blank" href="<#"><img class="social-icon-width" src="<?php echo base_url().'assets/front/img/social-icon/instagram sq.png' ?>"> </a>
                <a target="_blank" href="#"><img class="social-icon-width" src="<?php echo base_url().'assets/front/img/social-icon/Twitter sq.png' ?>"> </a>
                <a target="_blank" href="#"><img class="social-icon-width" src="<?php echo base_url().'assets/front/img/social-icon/Linkedin sq.png' ?>"> </a>
            </div>
          </div>
         <?php } ?>
      </div>
  ...
  <div class="modal-dialog m-0" style="height:auto;">
    <div class="modal-content" style="height:auto;">
      ...
      <div class="modal-header" style="padding: 0px 30px; border-bottom: 2px solid #3c3232;background: #17a2b8;line-height: 3rem;border-radius: initial;">
        ...
        <a style="color: #fff;" href="<?php echo site_url('home/profile_change_password/'.$groupname) ?>">Change Password</a>

        <a style="color: #fff;" id="editButtonMobile"  href="javascript:void(0)"> <i class="fa fa-edit"></i> Edit Profile</a>
      ...
      <div class="modal-body" style=" background: #4c4444; color: #fff;">
        <?php if (!empty($user)) { ?>
          ...
          <div class="row" id="linebotton">
            ...
            <div class="col-12" style="border-right:1px solid grey;">
              <a style="color: #fff;" onclick="change_location_set_cookie()" href="javascript:void(0)"> <p>Location <i  style="font-size:24px; float:right;color:#f27474" class="fa">&#xf041;</i></p></a>
            </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-header" id="register_form_hide">
        ...
        <ul class="nav nav-tabs">
         ...
         <button type="button" style="font-size: 34px;" class="close" data-dismiss="modal" aria-label="Close">
  ...
  <div id="login-form" class="tab-pane fade">
    ...
    <form method="post" class="log-form" style="<?php echo $style ?>">
      ...
      <div class="container-log-btn">
        ...
        <a style="float: left;margin-top: 1rem;font-size: 15px; font-weight: 700;" class="btn btn-info" href="<?php echo site_url('partner') ?>">Client Login</a>
      </div>
    ...
    <div class="modal-dialog m-0" style="height:auto;">
        <div class="modal-content" style="height:auto;">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                  <p>District / City <font color="red">*</font></p>
                  <select class="form-control" name="district" required="" onchange="get_district_location_id_current(this.value)" id="current_district">
                    <option value="">Select District</option>
                  </select>
                </div>
            </div>
