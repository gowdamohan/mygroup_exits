    ...
    <div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0">
      <div id="mCSB_1_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
        <ul class="x-navigation">
          ...
          <?php if ($users->group_id == 0) { ?>
            <li>
              <a href="<?php echo site_url('myads/admin_dashboard') ?>"><span class="fa fa-cogs"></span> <span class="xn-text">My Ads</span></a>   
            </li>
          <?php } ?>

          <?php if ($users->group_id == 0) { ?>
            <li>
              <a href="<?php echo site_url('franchise/corporate_login') ?>"><span class="fa fa-cogs"></span><span class="xn-text">Corporate Login</span></a>   
            </li>
          <?php } ?>
           ...
           <!--  <li>
             ...
             <li>
              <a href="<?php echo site_url('admin_controller/get_media_clientsbygroup/'.$users->group_id.'/'.'client_god') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">My God Client</span></a>
              <a href="<?php echo site_url('admin_controller/get_media_clientsbygroup/'.$users->group_id.'/'.'client') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">My Media Client</span></a>
          ...
          <?php if ($users->username == 'myneedy') { ?>
             <li>
              <a href="<?php echo site_url('admin_controller/get_needy_clientsbygroup/'.$users->group_id.'/'.'client') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">Needy Client</span></a>
            </li>
            <!-- <li>
          ...
          <?php if ($users->username == 'myunions') { ?>
            <li>
              <a href="<?php echo site_url('admin_controller/member_applications_form') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">Member Applications</span></a>
            </li>

            <li>
              <a href="<?php echo site_url('admin_controller/director_applications_form') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">Director Applications</span></a>
            </li>

            <li>
              <a href="<?php echo site_url('admin_controller/header_leader_applcation_form') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">Header/Leader Applications</span></a>
            </li>
            <li>
              <a href="<?php echo site_url('admin_controller/staff_applcation_form') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">Staff Applications</span></a>
            </li>
            <li class="xn-openable">
              <a href="#"><span class="fa fa-cogs"></span> <span class="xn-text">Data Base</span></a>   
              <ul>
                <li>
                  <a href="<?php echo site_url('admin_controller/client_database_unions') ?>"><span class="fa fa-bookmark"></span><span class="xn-text">Client Database</span></a>
                </li>
