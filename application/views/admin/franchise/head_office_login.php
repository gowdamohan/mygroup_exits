<ul class="breadcrumb">
   ...
   <li>Head Office Login</li>
</ul>
<div class="panel panel-default">
   <div class="panel-heading">
      <h3 class="panel-title">Head Office Login</h3>
   </div>
              ...
              <tr>
                  <?php 
                     ...
                     if (!empty($val->user_id)) {
                        $profile_url = site_url('franchise/create_franchise_staff/'.$val->user_id.'/headoffice');
                     }
                     $disabled = 'readonly';
                     if (!empty($val->user_id)) {
                        $disabled = '';
                  ...
                  <th><?php echo $i ?></th>
                  <th><a href="<?php echo $profile_url ?>"><?php echo $val->country ?></a></th>
                  ...
                  <input type="hidden" class="form-control" value="<?php echo $val->id ?>" name="franchise_country" id="franchise_country<?php echo $i ?>">
                  <input type="hidden" class="form-control" value="" name="franchise_state" id="franchise_state<?php echo $i ?>">
                  ...
                  <th>
                     ...
                     <a <?php echo $disabled ?> class="btn btn-danger" href="<?php echo site_url('franchise/franchise_reset_password/'.$val->user_id.'/'.'create_head_office_login') ?>">Reset password</a></th>
               </tr>
            <?php $i++; } ?>
         </tbody>
      </table>
...
<script type="text/javascript">
   function save_franchise_login_details(i) {
      ...
      var group_id = '6';
      var redirect_url = 'franchise/create_head_office_login';
      $.ajax({
