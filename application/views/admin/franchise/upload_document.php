<ul class="breadcrumb">
   ...
   <li><a href="<?php echo site_url('franchise/franchise_staff_details');?>">Franchise Staff Details</a></li>
...
<div class="panel panel-default">
   <div class="panel-heading">
    ...
    <div class="panel-body">
        <div class="col-md-6">
            <h3 style="border-bottom: 4px solid #be0808;">Upload Documents</h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form data-validation="true" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="franchise_staff_id" value="<?php echo $id ?>" id="franchise_staff_id">
