...
<div class="panel panel-default">
   ...
   <div class="panel-body">
      <div class="col-md-3">
         <div class="panel-body list-group list-group-contacts">
            <?php $i=1; foreach ($group_list as $key => $val) { ?>
               ...
               ?>
               <a href="<?php echo site_url('admin_controller/create_group_category/'.$group_name.'/'.$val) ?>" class="list-group-item <?php echo $active ?>">                               
      ...
      <div class="col-md-9">
         <a href="<?php echo site_url('admin_controller/group_single_category/'.$group_name.'/'.$category) ?>" class="btn btn-primary <?php if($selectedCatButton == 'singleActive') echo 'selectedactve' ?> ">Category</a>
         <a href="<?php echo site_url('admin_controller/group_single_category/'.$group_name.'/'.$category) ?>" class="btn btn-primary  <?php if($selectedCatButton == 'subActive') echo 'selectedactve' ?>">Sub Category</a>
         <a href="" class="btn btn-primary <?php if($selectedCatButton == 'subSubActive') echo 'selectedactve' ?>">Sub Sub Category</a>

         <form enctype="multipart/form-data" method="post" id="category-form" action="<?php echo site_url('admin_controller/insert_category_data_group_wise/'.$group_name.'/'.$category) ?>" class="form-horizontal" data-parsley-validate > 
            <div class="panel-body">
