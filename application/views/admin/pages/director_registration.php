...
<div class="panel panel-default">
  <form enctype="multipart/form-data" method="post" id="demo-form" action="<?php echo site_url('admin_controller/director_registration_insert');?>" data-parsley-validate="" class="form-horizontal">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <?php if(admission_is_enabled($enabled_fields, 'name')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
                 <input type="text" required="" autocomplete="off" name="director_name" class="form-control" placeholder="Director Name">
              </div>
            </div>
          <?php endif ?>
          ...
          <?php endif ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input type="text" required="" onkeyup="checkMobileNumberExits()" autocomplete="off" name="mobile_number" class="form-control" id="mobile_number" placeholder="Mobile Number">
          ...
          <?php if(admission_is_enabled($enabled_fields, 'photo')) :  ?>
            ...
            <div class="form-group">
              <label class="control-label col-sm-3" for="no_of_days">Director Photo</label>
              <div class="col-sm-8">
        ...
        <div class="panel-footer">
          <center><button type="submit" id="btnSubmit" class="btn btn-info">Submit</button></center>
        </div>
      </div>
  </form>
</div>
