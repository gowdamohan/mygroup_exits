...
<div class="panel panel-default">
  <form enctype="multipart/form-data" method="post" id="demo-form" action="<?php echo site_url('admin_controller/director_registration_update/'.$edit_director->id);?>" data-parsley-validate="" class="form-horizontal">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-titile">Director Registration
            <a style="float: right;" href="<?php echo site_url('admin_controller/director_registration_index') ?>" class="btn btn-primary">View Application</a>
          </h3>
        </div>
        <?php 
        $country = 0;
        ...
        <div class="panel-body">
          ...
          <?php if(admission_is_enabled($enabled_fields, 'name')) :  ?>
            <div class="form-group">
              <label class="control-label col-md-3">Director Name <font color="red">*</font></label>
              <div class="col-md-8">
                 <input type="text" required="" value="<?php echo $edit_director->name ?>" autocomplete="off" name="director_name" class="form-control" placeholder="Director Name">
              </div>
            </div>
          <?php endif ?>
          ...
          <?php if(admission_is_enabled($enabled_fields, 'designation')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
                 <input type="text" required="" value="<?php echo $edit_director->designation ?>" autocomplete="off" name="designation" class="form-control" placeholder="Designation">
              </div>
            </div>
          <?php endif ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input type="text" required="" onkeyup="checkMobileNumberExits()" autocomplete="off" name="mobile_number" class="form-control" value="<?php echo $edit_director->mobile_number ?>" id="mobile_number" placeholder="Mobile Number">
          ...
          <?php if(admission_is_enabled($enabled_fields, 'email_id')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
                 <input type="text" autocomplete="off" value="<?php echo $edit_director->email_id ?>" name="email_id" class="form-control" placeholder="Email-Id">
              </div>
            </div>
          <?php endif ?>
          ...
          <?php if(admission_is_enabled($enabled_fields, 'description')) :  ?>
            <div class="form-group">
              <label class="control-label col-md-3">About Director  </label>
              <div class="col-md-8">
                <textarea class="form-control" autocomplete="off" name="description" rows="5"><?php echo $edit_director->description ?></textarea>
              </div>
            </div>
          <?php endif ?>
          ...
          <?php if(admission_is_enabled($enabled_fields, 'address')) :  ?>
            <div class="form-group">
              <label class="control-label col-md-3">Address Director  </label>
              <div class="col-md-8">
                <textarea class="form-control" autocomplete="off" name="address" rows="5"><?php echo $edit_director->address ?></textarea>
              </div>
            </div>
          <?php endif ?>
          ...
          <?php if(admission_is_enabled($enabled_fields, 'name_of_media')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
               <input type="text" autocomplete="off" value="<?php echo $edit_director->name_of_media ?>" name="name_of_media" class="form-control" placeholder="Name of the Media">
              </div>
            </div>
          <?php endif ?>
          ...
          <?php if(admission_is_enabled($enabled_fields, 'designation_in_media')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
               <input type="text" autocomplete="off" value="<?php echo $edit_director->designation_in_media ?>" name="designation_in_media" class="form-control" placeholder="Designation in Media">
              </div>
            </div>
          <?php endif ?>
          ...
          <?php if(admission_is_enabled($enabled_fields, 'photo')) :  ?>
            ...
            <div class="form-group">
              <label class="control-label col-sm-3" for="no_of_days">Member Photo </label>
              <div class="col-sm-8">
                <img  onclick="$('#fileupload').click();"  class="img-responsive img-circle" id="profile_photo" src="<?php echo (!empty($edit_director->photo) == '') ? base_url().'assets/front/logo.png' : $this->filemanager->getFilePath($edit_director->photo); ?> " style="width:60px;height:60px">
