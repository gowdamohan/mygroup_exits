<div class="panel panel-default">
    <div class="panel-heading ui-draggable-handle">
        <h3 class="panel-title">Nearest Place</h3>         
    </div>
  <?php 
    if (!empty($god_nearest_places_edit)) { ?>
      <form enctype="multipart/form-data" method="post" action="<?php echo site_url('client_controller/update_god_nearest_places_byid/'.$god_nearest_places_edit->id) ?>"  id="god_event_form1"  class="form-horizontal" data-parsley-validate >
        <div class="panel-body table-responsive">
          <div class="col-md-6 col-md-offset-2">
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                <input type="text" name="name_of_the_place" value="<?php echo $god_nearest_places_edit->name_of_the_place ?>" class="form-control" id="name_of_the_place" >
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8 imgUp">
                 <?php
                   $img = '';
                   $labelName = 'Upload';
                   if (!empty($god_nearest_places_edit->god_nearest_place_file)) { 
                      $labelName = 'Change';
                      $imgpath = $this->filemanager->getFilePath($god_nearest_places_edit->god_nearest_place_file); 
                ...
                <label class="btn btn-warning">Change Event Photo<input type="file" name="god_nearest_place_file" id="fileupload" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;"></label>
              </div>
            ...
            <div class="form-group" id="textSummernote">
              ...
              <div class="col-sm-8">
                <textarea class="summernote" required="" name="description" id="description"><?php echo $god_nearest_places_edit->description ?></textarea>
              </div>
            </div>
          </div>
        </div>
    ...
    <?php }else{ ?>
      <form enctype="multipart/form-data" method="post" action="<?php echo site_url('client_controller/update_god_nearest_places') ?>"  id="god_event_form"  class="form-horizontal" data-parsley-validate >
        <div class="panel-body table-responsive">
          <div class="col-md-6 col-md-offset-2">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8 imgUp">
                ...
                <span id="percentage-completed_today_main_img" style="font-size: 40px;position: absolute;top: 31%;left: 38%;right: 0px;color: white;display: none;">0 %</span>
                <label class="btn btn-warning">Upload Event Photo<input type="file" name="god_nearest_place_file" id="fileupload" class="uploadFile img" value="Upload Photo" style="width: 0px;height: 0px;overflow: hidden;"></label>
              </div>
  ...
  function update_god_event_by_id() {
    ...
    <div class="panel-body table-responsive">
      <table class="table table-bordered">
        ...
        <tbody>
          <?php if (!empty($god_nearest_places)) { ?>
            <?php $i=1; foreach ($god_nearest_places as $key => $aw) { ?>
              <tr>
                <td><?php echo $i++ ?></td>
                ...
                <td>
                  <label for="logo" class="upload-field" id="file-label">
                    <div class="file-thumbnail">
                      <img id="image-preview" src="<?php echo $this->filemanager->getFilePath($aw->god_nearest_place_file) ?>" alt="">
                    </div>
                  </label>
                </td>
                <td><a class="btn btn-danger" href="<?php echo site_url('client_controller/edit_god_nearest_places/'.$aw->id) ?>">Edit</a></td>
              </tr>
            <?php } ?>
          <?php }else{
