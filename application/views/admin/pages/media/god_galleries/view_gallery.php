<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('client_controller/god_create_gallery'); ?>">Galleries</a></li>
</ul>
<hr>
...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <ul class="panel-controls hidden-sm" style="float:right">
            <li><a href="<?php echo site_url('client_controller/god_create_gallery'); ?>" data-placement="top" data-toggle="tooltip" data-original-title="Back" class="control-primary"><span class="fa fa-mail-reply"></span></a>
                <span>&nbsp; &nbsp; &nbsp; &nbsp; </span>
            </li>
        </ul>
    </div>
...
$("#up-btn").click(function() {
    $('#up-btn').val('Please wait ...').attr('disabled', 'disabled');
        ...
        // return false;
        $.ajax({
            url: '<?php echo site_url('client_controller/god_upload_multiple_images') ?>',
            type: 'post',
            data: form_data,
            cache: false,
            contentType: false,
            ...
            callback: function(result) {
                if (result) {
                    $.ajax({
                        ...
                        url: '<?php echo site_url('client_controller/god_delete_image'); ?>',
                        type: 'post',
                        data: {
                            'image_id': image_id
                        },
