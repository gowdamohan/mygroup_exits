...
<div class="panel panel-default">
  <form enctype="multipart/form-data" method="post" id="demo-form" action="<?php echo site_url('admin_controller/client_application_configure_fields');?>" data-parsley-validate="" class="form-horizontal">
    <div class="col-md-6">
      <div class="panel panel-default">
