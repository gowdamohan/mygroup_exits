...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <form enctype="multipart/form-data" method="post" action="<?php echo site_url('admin_controller/member_applications_form') ?>" class="form-horizontal" data-parsley-validate >
  ...
  <form enctype="multipart/form-data" method="post" action="<?php echo site_url('admin_controller/insert_member_application_config_fields_admin/'.$unionCat);?>" data-parsley-validate="" class="form-horizontal">
        <div class="panel-body">
                ...
                foreach ($enabled_fields as $key => $val) { ?>
                  <?php if ($val != 'present_area' && $val != 'present_district' && $val != 'present_state' && $val != 'present_country' && $val != 'present_pincode' && $val != 'permanent_area' && $val != 'permanent_district' && $val != 'permanent_state' && $val != 'permanent_country' && $val != 'permanent_pincode') { ?>
                    <tr>
                      ...
                      <td style="vertical-align: middle; text-align: center;">
                        <input type="checkbox" <?php if (in_array($val, $selected_required_fields)) echo 'checked' ?> name="required_fields[]" style="width: 18px;height: 18px;" value="<?php echo $val ?>" readonly="true" onclick="onclick_required_fields('<?php echo $val ?>')" id="required<?php echo $val ?>" >
                      </td>
                      <td>
                        <div class="form-group">
