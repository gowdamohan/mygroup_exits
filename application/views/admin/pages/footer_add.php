<div class="panel panel-default">
    <div class="panel-heading ui-draggable-handle">
        <h3 class="panel-title"><?php echo str_replace('_', ' ', $pagename) ?> Add</h3>         
    </div>
    ...
    <form enctype="multipart/form-data" method="post" id="students" action="" class="form-horizontal" data-parsley-validate >
        ...
        <div class="panel-footer">
            <center>
               <input type="button" value="Upload" onclick="uploadFooterPage()" id="up-btn" class="btn btn-primary">
...
function uploadFooterPage() {
    ...
    summernote = $('#summernote').code();
      ...
      // return false;
      $.ajax({
          url: '<?php echo site_url('admin_controller/upload_footer_page/') ?>'+pageName,
          type: 'post',
          data: form_data,
          cache: false,
          contentType: false,
