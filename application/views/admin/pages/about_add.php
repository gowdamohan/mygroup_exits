<div class="panel panel-default">
    ...
    <form enctype="multipart/form-data" method="post" id="students" action="" class="form-horizontal" data-parsley-validate >
        ...
        <div class="panel-footer">
            <center>
               <input type="button" value="Upload" onclick="uploadAbout()" id="up-btn" class="btn btn-primary">
               <a class="btn btn-danger" href="<?php echo site_url('admin_controller/about_us') ?>">Cancel / Back</a>
            </center>
        </div>
    </form>
</div>
...
function uploadAbout() {
    ...
    if (file_data.length === 0) { 
      ...
      // return false;
      $.ajax({
          url: '<?php echo site_url('admin_controller/upload_about') ?>',
          type: 'post',
          data: form_data,
          cache: false,
          contentType: false,
