<div class="panel panel-default">
    <div class="panel-heading ui-draggable-handle">
        <h3 class="panel-title">Union EMAIL Service</h3>         
    </div>

    <form enctype="multipart/form-data" method="post" action="<?php echo site_url('client_controller/upload_client_union_press_note') ?>"  id="union-news" action="" class="form-horizontal" data-parsley-validate >
        <div class="panel-body table-responsive">
          <div class="col-md-6 col-md-offset-2">
            <div class="form-group">
              <label class="control-label col-sm-4">EMAIL FOR</label>
              <div class="col-md-8">
                <div class="col-md-6" style="padding:0">
                  <div class="form-check form-check-inline" style="font-size:20px;">
                    <input class="form-check-input" style="height: 20px;width: 20px;" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="Member" checked>
                    <label class="form-check-label" for="inlineRadio1">EMAIL for Member</label>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-sm-4">EMAIL Content</label>
              <div class="col-md-8">
    ...
    <div class="panel-body table-responsive">
      <table class="table table-bordered">
        ...
        <tbody>
          <?php if (!empty($client_union_press_note)) { ?>
            <?php $i=1; foreach ($client_union_press_note as $key => $aw) { ?>
              <tr>
                <td><?php echo $i++ ?></td>
                <td><?php echo $aw->news_notice_type ?></td>
                <td><?php echo $aw->news_letter_name ?></td>
                <td><a onclick="return confirm('Are you going to  delete this document. Are you sure? ')" class="btn btn-danger" href="<?php echo site_url('client_controller/delete_union_press_note/'.$aw->id) ?>">Delete</a></td>
              </tr>
            <?php } ?>
          <?php }else{
            echo " <tr><th colspan='4' class='text-center'><h3>No Press note Found</h3></th></tr>";
          } ?>
        </tbody>
      </table>
    </div>
