<div class="panel panel-default">
    ...
    <form enctype="multipart/form-data" method="post" action="<?php echo site_url('client_controller/upload_client_union_notice') ?>"  id="union-news" action="" class="form-horizontal" data-parsley-validate >
    ...
    <div class="panel-body table-responsive">
      <table class="table table-bordered">
        ...
        <tbody>
          <?php if (!empty($client_union_notice)) { ?>
            <?php $i=1; foreach ($client_union_notice as $key => $aw) { ?>
              <tr>
                <td><?php echo $i++ ?></td>
                <td><?php echo $aw->news_notice_type ?></td>
                <td><?php echo $aw->news_letter_name ?></td>
                <td><?php echo $aw->description ?></td>
                <td><a onclick="return confirm('Are you going to  delete this document. Are you sure? ')" class="btn btn-danger" href="<?php echo site_url('client_controller/delete_union_notice/'.$aw->id) ?>">Delete</a></td>
              </tr>
            <?php } ?>
          <?php }else{
            echo " <tr><th colspan='4' class='text-center'><h3>No Notice Found</h3></th></tr>";
          } ?>
        </tbody>
      </table>
    </div>
