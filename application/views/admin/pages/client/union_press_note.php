<div class="panel panel-default">
    <div class="panel-heading ui-draggable-handle">
        <h3 class="panel-title">Union Notice</h3>         
    </div>
        ...
        <div class="panel-body table-responsive">
          <div class="col-md-6 col-md-offset-2">
            ...
            <div class="form-group">
              <label class="control-label col-sm-4">Member type</label>
              <div class="col-md-8">
                <div class="col-md-6" style="padding:0">
                 <div class="form-check form-check-inline" style="font-size:20px;">
                    <input class="form-check-input" style="height: 20px;width: 20px;" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="Public" checked>
