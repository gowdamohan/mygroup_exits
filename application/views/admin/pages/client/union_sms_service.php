<div class="panel panel-default">
    <div class="panel-heading ui-draggable-handle">
        <h3 class="panel-title">Union SMS Service</h3>         
    </div>
        ...
        <div class="panel-body table-responsive">
          <div class="col-md-6 col-md-offset-2">
            <div class="form-group">
              <label class="control-label col-sm-4">SMS FOR</label>
              <div class="col-md-8">
                <div class="col-md-6" style="padding:0">
                  <div class="form-check form-check-inline" style="font-size:20px;">
                    ...
                    <label class="form-check-label" for="inlineRadio1">SMS for Member</label>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-sm-4">SMS Content</label>
              <div class="col-md-8">
