...
<script type="text/javascript">
    ...
    <div class="panel-body table-responsive" id="header_leaderData">  
        ...
        <a class="btn btn-primary" style="float: right;" href="<?php echo site_url('admin_controller/header_leader_registration/'.$type.'/'.$leader_head) ?>" >ADD <?php echo str_replace('_', ' ', strtoupper($leader_head)) ?></a>
        <div id="printArea">
