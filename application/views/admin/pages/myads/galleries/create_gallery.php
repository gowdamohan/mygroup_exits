<ul class="breadcrumb">
    ...
    <li><a href="<?php echo site_url('myads/gallery');?>">Galleries Dashboard</a></li>
    <li>Galleries</li>
</ul>
<hr>
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">
            <form enctype="multipart/form-data" id="gallery-form" action="<?php echo site_url('myads/gallery_created'); ?>"
                ...
                <div class="panel panel-default new-panel-style_3">
                    <div class="panel-heading new-panel-heading">
                        ...
                        <ul class="panel-controls" style="float:right">
                            <li>
                                <a  href="<?php echo site_url('myads/gallery');?>" data-placement="top" data-toggle="tooltip" data-original-title="Back" class="control-primary"><span class="fa fa-mail-reply"></span></a>
                            </li>
                        </ul>
                    </div>
                ...
                <center>
                    ...
                    <a class="btn btn-danger" href="<?php echo site_url('myads/gallery'); ?>">Cancel</a>
                    <?php //}else{ ?>
