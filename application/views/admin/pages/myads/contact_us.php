<div class="panel panel-default">
    ...
    <?php if (!empty($contact)) { ?>
       <form enctype="multipart/form-data" method="post" id="students" action="<?php echo site_url('myads/update_contact_by_id/'.$contact->id) ?>" class="form-horizontal" data-parsley-validate >
        ...
        <div class="panel-footer">
            <center>
               ...
               <a class="btn btn-danger" href="<?php echo site_url('myads/contact_us') ?>">Cancel / Back</a>
            </center>
        </div>
        </form>
    <?php }else{ ?>
        <form enctype="multipart/form-data" method="post" id="students" action="<?php echo site_url('myads/update_contact') ?>" class="form-horizontal" data-parsley-validate >
        <div class="panel-body table-responsive">
           <div class="col-md-6 col-md-offset-2">
