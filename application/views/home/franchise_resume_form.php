 ...
 <div class="row" style="margin: 0px;">
      <div class="col-md-6">
        <h3 class="card-title panel_title_new_style_staff">
            <a class="back_anchor" href="<?php echo site_url('home/apply_for_franchaise/'.$groupname) ?>" class="control-primary">
        ...
        <div class="container">
            <div class="panel-body">
                ...
                <div class="col-md-6 col-md-offset-2">
                    <form enctype="multipart/form-data" method="post" id="franchise_apply-now" action="<?php echo site_url('home/apply_franchise_insert/'.$groupname) ?>" class="form-horizontal" data-parsley-validate>
                        <div class="form-group" style="<?php echo $country ?>" >
                            <p>Country <font color="red"> *</font></p>
                            <select class="form-control" <?php echo $countryR ?> id="franchiseCountry" onchange="content_get_state()" name="franchise_country">
                        ...
                        <div class="form-group" style="<?php echo $state ?>">
                            <p>State <font color="red"> *</font></p>
                            <select class="form-control" <?php echo $stateR ?> id="franchiseState" onchange="get_district_by_state(this.value)" name="franchise_state">
                                <option value=""></option>
                            </select>
                        </div>

                        <div class="form-group" style="<?php echo $district ?>">
                            <p>District <font color="red"> *</font></p>
                            <select class="form-control" <?php echo $districtR ?> id="franchiseDistrict" name="franchise_district">
                                <option value=""></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <p>Do you have Laptop/Computer <font color="red"> *</font></p>
                           <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="laptop_computer" id="inlineRadio1" value="Yes">
                              <label class="form-check-label" for="inlineRadio1">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="laptop_computer" id="inlineRadio2" value="No">
                              <label class="form-check-label" for="inlineRadio2">No</label>
                            </div>
                        </div>

                        <div class="form-group">
                            <p>Are you studied in Govt School? <font color="red"> *</font></p>
                           <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="govt_school" id="inlineRadio3" value="Yes">
                              <label class="form-check-label" for="inlineRadio3">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" type="radio" name="govt_school" id="inlineRadio4" value="No">
                        ...
                        <button type="button" onclick="submitfranchise()" id="btnFranchiseSubmit" class="btn btn-info btn-lg btn-block">Submit</button>
                    </form>
                </div>
            </div>
        </div>
...
pdfjsLib.GlobalWorkerOptions.workerSrc = 'https://mozilla.github.io/pdf.js/build/pdf.worker.js';
    ...
    function content_get_state() {
      var countryId = $('#franchiseCountry').val();
      $.post("<?php echo site_url('country_controller/get_state_by_countryId')?>",{countryId:countryId},function(data){
        ...
        $('#franchiseState').html(output);
        $('#franchiseDistrict').html(output1);
     });
    }
