...
<div class="panel panel-default">
  <form enctype="multipart/form-data" method="post" id="demo-form" action="<?php echo site_url('myunions/member_registration_insert');?>" data-parsley-validate="" class="form-horizontal">
    ...
    <input type="hidden" name="user_name" value="<?php echo $user_data->username ?>">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-8">
              <select class="form-control" <?php echo ($country == 1) ? 'required':'' ?> name="union_location_country" id="union_location_country">
                ...
                <?php foreach ($country_flag as $key => $country) { ?>
                  <option <?php if ($user_regiser->country == $country->id) echo 'selected' ?> value="<?php echo $country->id ?>"><?php echo $country->country ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
          ...
          <?php if(union_is_enabled($enabled_fields, 'full_name')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
                 <input type="text" <?php if(union_is_required_fields($required_fields,'full_name')) echo 'required' ?> autocomplete="off" name="full_name" class="form-control" value='<?php echo $user_data->first_name ?>' placeholder="Full Name">
              </div>
            </div>
          <?php endif ?>
          ...
          <?php if(union_is_enabled($enabled_fields, 'display_name')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
                 <input type="text" <?php if(union_is_required_fields($required_fields,'display_name')) echo 'required' ?> autocomplete="off" name="display_name" class="form-control" value='<?php echo $user_data->display_name ?>' placeholder="Display Name">
              </div>
            </div>
          <?php endif ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                 <input type="text" <?php if(union_is_required_fields($required_fields,'mobile_number')) echo 'required' ?> autocomplete="off" name="mobile_number" readonly value='<?php echo $user_data->username ?>' class="form-control">
              </div>
            </div>
         ...
         <?php if(union_is_enabled($enabled_fields, 'email_id')) :  ?>
            <div class="form-group">
              ...
              <div class="col-md-8">
                 <input type="text" autocomplete="off" <?php if(union_is_required_fields($required_fields,'email_id')) echo 'required' ?> name="email_id" class="form-control" value='<?php echo $user_data->email ?>' placeholder="Email-Id">
              </div>
            </div>
          <?php endif ?>
              ...
              <div class="col-12 row">
                <div class="col-4" style="padding-right: 2px;">
                      <select name="from_date" <?php if(union_is_required_fields($required_fields,'date_of_birth')) echo 'required' ?> class="form-control" id="from_date">
                        ...
                        <option <?php if($user_regiser->dob_date == '01') echo 'selected' ?> value='01'>01</option>
                        <option <?php if($user_regiser->dob_date == '02') echo 'selected' ?> value='02'>02</option>
                        <option <?php if($user_regiser->dob_date == '03') echo 'selected' ?> value='03'>03</option>
                        <option <?php if($user_regiser->dob_date == '04') echo 'selected' ?> value='04'>04</option>
                        <option <?php if($user_regiser->dob_date == '05') echo 'selected' ?> value='05'>05</option>
                        <option <?php if($user_regiser->dob_date == '06') echo 'selected' ?> value='06'>06</option>
              ...
              <div class="col-md-8">
                <select class="form-control" <?php if(union_is_required_fields($required_fields,'education')) echo 'required' ?> name="education" id="education">
                    ...
                    <?php foreach ($education as $key => $val) { ?>
                      <option <?php if($user_regiser->education == $val->education) echo 'selected' ?> value="<?php echo $val->education ?>"><?php echo $val->education ?></option>
                    <?php } ?>
                </select>
              </div>
            </div>
              ...
              <div class="col-md-8">
                <select class="form-control" <?php if(union_is_required_fields($required_fields,'work_profession')) echo 'required' ?> name="work_profession" id="work_profession">
                  ...
                  <?php foreach ($profession as $key => $val) { ?>
                   <option <?php if($user_regiser->profession == $val->profession) echo 'selected' ?> value="<?php echo $val->profession ?>"><?php echo $val->profession ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
          ...
          <?php if(union_is_enabled($enabled_fields, 'member_photo')) :  ?>
            ...
            <div class="form-group">
              <label class="control-label col-md-3" for="no_of_days">Member Photo <?php if(union_is_required_fields($required_fields,'member_photo')) echo '<font color="red">*</font>' ?></label>
              <div class="col-8">
                  <img  onclick="$('#publicfileupload').click();"  class="img-responsive img-circle" id="union_member_profile_photo" src="<?php echo base_url().'assets/front/logo.png' ?>" style="width:60px;height:60px">

                <input hidden="hidden" <?php if(union_is_required_fields($required_fields,'member_photo')) echo 'required' ?> type="file" id="publicfileupload" class="file" data-preview-file-type="jpeg" name="profile_photo" accept="image/*">
          ...
          <?php if (!empty($member_validity)) { ?>
            <div class="form-group">
              <label class="control-label col-md-3" for="no_of_days">Choose Membership <font color="red">*</font></label>
              <div class="col-8">
                <select class="form-control" name="membership_amount" id="memberShipPaid">
                  <option value="">Select Members ship amount</option>
                  <?php foreach ($member_validity as $amount => $val) { ?>
                    <option value="<?php echo $val.'_'.$amount ?>"><?php echo $val . ' (Rs. '.$amount.') ' ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
