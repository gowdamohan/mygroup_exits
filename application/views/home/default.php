...
<body>
	...
	<div class="flex-w flex-col-c-sb p-l-15 p-r-15 ">
		<span></span>
		<div class="flex-col-c ">
			<div class="container">
		        <div class="row">

		            <div class="col-lg-12 col-md-8 login-box">
                	  	<br>
		                <div class="col-lg-12 login-key">
		                	<img style="width:35%" src="<?php echo base_url().'uploads/group/logo.png' ?>">
		                </div>
		                <div class="col-lg-12 login-title">
		                    LOGIN
		                </div>

		                <div class="col-lg-12 login-form" style="width:350px;">
		                    <div class="col-lg-12 login-form">
		                        <form>
		                            ...
		                            <div class="col-lg-12 loginbttm">
		                            	<a onclick="register_user()" href="javascript:void(0)">Forgot password?</a>
		                            	<br>
		                            	<br>
