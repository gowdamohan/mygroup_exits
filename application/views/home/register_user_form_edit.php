    ...
    <div class="login-body">
      ...
      <form method="post" class="form-horizontal" action='<?php echo site_url("home/user_register_update/".$profile_edit->user_id);?>' data-parsley-validate="">
        ...
        <div class="panel-body" id="contentId">
          <div class="login-title"><strong>Register form </strong></div>
          <?php 
          ...
          ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                ...
                <div class="col-md-1" style="padding: 0px 2px 0px 0px; ">
              ...
              <div class="col-md-8">
                ...
                <div class="col-md-2" style="padding: 0px 2px 0px 0px ;">
                  <select class="form-control" name="country_code_alter" id="counry_code_alter">
                     <option value="<?php echo $profile_edit->country_code_alter ?>"><?php echo $profile_edit->country_code_alter ?></option>
                  </select>
                </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                  <label class="radio-inline" for="gender-0">
                      <input type="radio" data-parsley-group="block0" class="gender-radio" <?php if($profile_edit->gender == 'M') echo 'checked' ?> name="gender" <?php if($profile_edit->marital == 'Single') echo 'checked' ?> id="gender-0" value="M" checked>
                      Male
                  </label>
                  <label class="radio-inline" for="gender-1">
                      <input type="radio"  <?php if($profile_edit->marital == 'Married') echo 'checked' ?>  data-parsley-group="block1" class="gender-radio" <?php if($profile_edit->gender == 'F') echo 'checked' ?>  name="gender" id="gender-1" value="F">
                      Female
                  </label>
                   <label class="radio-inline" for="gender-1">
                      <input type="radio"  <?php if($profile_edit->marital == 'Other') echo 'checked' ?> data-parsley-group="block2" class="gender-radio" name="gender" <?php if($profile_edit->gender == '0') echo 'checked' ?>   id="gender-2" value="o">
                      Transgender
                  </label>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-8">
                  <label class="radio-inline" for="marital-0">
                      <input type="radio" <?php if($profile_edit->marital == 'Single') echo 'checked' ?>  data-parsley-group="block0" class="marital-radio" name="marital" id="marital-0" value="Single" checked>
                      Single
                  </label>
                  <label class="radio-inline" for="marital-1">
                      <input type="radio"  <?php if($profile_edit->marital == 'Married') echo 'checked' ?> data-parsley-group="block1" class="marital-radio" name="marital" id="marital-1" value="Married">
                      Married
                  </label>
                   <label class="radio-inline" for="marital-1">
                      <input type="radio" <?php if($profile_edit->marital == 'Other') echo 'checked' ?> data-parsley-group="block2" class="marital-radio" name="marital" id="marital-2" value="Other">
                      Other
                  </label>
              </div>
            </div>
