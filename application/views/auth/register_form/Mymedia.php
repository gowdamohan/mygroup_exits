            ...
            <div class="wrap-login100 glass">
                  <form id="register-form" enctype="multipart/form-data"  class="form-horizontal" action="<?php echo site_url().'/home/client_register_submit';?>" style="text-align: center;" method="post">
                    ...
                    <div class="wrap-input100 validate-input" >
                        <input id="first_name" class="input100" type="text" required="" name="first_name" placeholder="Admin Name">
                    ...
                    <div class="wrap-input100 validate-input" >
                     ...
                     <script type="text/javascript">
                        $(document).ready(function(){
                            get_category_by_mediatype();
                        });
                        function get_category_by_mediatype() {
                            var media_type = 'mygod';

                            $.post("<?php echo site_url('home/media_category_get_by_type')?>",{media_type:media_type},function(data){
                              ...
                              $('#media_category').html(output);
                            });
                          
                        }
                    </script>
                    <div class="wrap-input100 validate-input" >    
                       <select class="input100" required="" id="media_category" name="category">
