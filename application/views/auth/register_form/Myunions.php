...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/back_end/login/fonts/iconic/css/material-design-iconic-font.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/back_end/login/css/util.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url()?>assets/back_end/login/css/main.css">
...
<!--===============================================================================================-->
    ...
    <script type="text/javascript" src="<?php echo base_url();?>assets/back_end/js/plugins/jquery/jquery-ui.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>assets/back_end/js/plugins/bootstrap/bootstrap.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url();?>assets/back_end/js/plugins.js"></script>
<style>
.glass
    {
width:400px;
            ...
            <div class="wrap-login100 glass">
                  <form id="register-form" enctype="multipart/form-data"  class="form-horizontal" action="<?php echo site_url().'/home/client_register_submit';?>" style="text-align: center;" method="post">
                    ...
                    <div class="wrap-input100 validate-input" >
                        <input id="first_name" class="input100" type="text" required="" name="name_of_the_organization" placeholder="Name of the Organization">
                    ...
                    <div class="wrap-input100 validate-input" >
                        <input id="email_id" class="input100" type="email" required="" name="email" placeholder="Your Email Id">
                        <span class="glyphicon glyphicon-envelope abc"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" >
                       ...
                       <select class="input100" required="" onchange="filter_country_dropdown(this.value)" id="type" name="type">
                    ...
                    <div class="wrap-input100 validate-input" >
                        <select name="country" class="input100" disabled="true" onchange="get_country_wise_state()" id="country">
                    ...
                    <div class="wrap-input100 validate-input" >
                        <select name="state" class="input100" disabled="true" onchange="get_state_wise_disctrict()" id="state">
                    ...
                    <div class="wrap-input100 validate-input" >
                        <select name="district" class="input100" disabled="true" id="district">
                    ...
                    <div class="wrap-input100 validate-input">
                        <select class="input100" id="union_type" onchange="get_category_by_uniontype()" name="union_type">
                            <option value="">Union Type</option>
                            <option value="unions">UNIONS</option>
                            <option value="federation">FEDERATION</option>
                            <option value="ids">IDENTITY</option>
                        </select>
                        <span class="glyphicon glyphicon-phone abc"></span>
                    </div>
                    <script type="text/javascript">
                        function get_category_by_uniontype() {
                            var union_type = $('#union_type').val();
                            $.post("<?php echo site_url('client_controller/union_category_get_by_type')?>",{union_type:union_type},function(data){
                              var utype = jQuery.parseJSON(data);
                              console.log(utype);
                              var output='';
                              output+='<option value="">Select Category</option>';
                              for (var i = 0; i < utype.length; i++) {
                                output+='<option value="'+utype[i].id+'">'+utype[i].category+'</option>'; 
                              }
                              $('#union_category').html(output);
                            });
                    ...
                    <div class="wrap-input100 validate-input" >
                       ...
                       <select class="input100" required="" id="union_category" name="category">
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <button type="submit" id="regsiter" class="login100-form-btn"> <i class="fa fa-sign-in" aria-hidden="true"></i> &nbsp; Register</button>
                    </div>
