...
<body>
    ...
    <div class="bg-g1 size1 flex-w flex-col-c-sb p-l-15 p-r-15 p-t-55 p-b-35 respon1">
        ...
        <div class="flex-col-c p-t-20 p-b-50">
            ...
            <a class="flex-c-m s1-txt2 size3 how-btn" href="<?php echo site_url('client-login/'.'Mymedia') ?>" style="color:white; margin-bottom: 1rem; ">
                <img  style="width: 20px;" src="<?php echo base_url().$logo->icon ?>"> &nbsp;&nbsp; Mymedia
            </a>
            
            <a class="flex-c-m s1-txt2 size3 how-btn" href="<?php echo site_url('god-login/'.'Mymedia/'.'Mygod') ?>" style="color:white; margin-bottom: 1rem; ">
                <img  style="width: 20px;" src="<?php echo base_url().'assets/front/img/god.png' ?>"> &nbsp;&nbsp; Mygod
            </a>
