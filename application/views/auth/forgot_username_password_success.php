        ...
        <div class="wrap-login100 glass">
          <span class="login100-form-logo">
            ...
            <form id="demo-form" class="form-horizontal" action="<?php echo site_url('auth/login');?>" method="post">
                ...
                <p style="color:black; font-size: 16px; font-weight:400">User Name : <?= $success_data['username_dispaly'] ?></p>
           ...
           <div class="container-login100-form-btn" style="margin-top:2rem;margin-bottom: 2rem;">
              <a class="login100-form-btn" href="<?php echo site_url('home') ?>">Goto Login</a>
            </div>
         </div>
      </div>
