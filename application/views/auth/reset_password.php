  ...
  <div class="container-login100" style="background:#ccc">
    <div class="wrap-login100 glass">
        <span class="login100-form-logo">
            <img width="100px" style="margin-bottom:0.8rem" class="img-responsive" src="<?php echo base_url().'assets/front/img/logo.jpg' ?>">
        </span>
        <form id="reset-form" action="" method="post">

          <input type="hidden" name="mobileNumber" id="mobileNumber" value="<?= $user_name ?>">

          <div class="form-group">
            <p id="usernamedisplay"> User Name :  <?= $user_name ?></p>
          </div>
           <div class="form-group">                  
       ...
       <!-- <div class="container-login100-form-btn" style="margin-top:2rem;margin-bottom: 2rem;">
          <a onclick="back_redirect()" href="javascript:void(0)"> Back</a>
        </div> -->
    ...
    if (password.length != 0 && cnfrmPassword.length != 0) {
      if (password == cnfrmPassword) {
        ...
        $.ajax({
          ...
          type:'post',
          data: {'password':password,'mobileNumber':mobileNumber},
          success: function(data) {
            if (data == 1) {
              window.location.href = '<?php echo site_url('auth/success') ?>';
            }else{
