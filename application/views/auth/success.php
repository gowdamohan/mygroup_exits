    ...
    <div class="limiter">
      <div class="container-login100" style="background:#ccc">
        <div class="wrap-login100 glass">
          ...
          <p style="color:black; font-size: 16px; font-weight:400">Please login with your new password</p>
          <div class="container-login100-form-btn" style="margin-top:2rem;margin-bottom: 2rem;">
            <a class="login100-form-btn" href="<?php echo site_url('home/profile') ?>">Goto Login</a>
          </div>
         </div>
      </div>
    </div>
